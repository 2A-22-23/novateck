...
if(isset($_POST['filter'])){
    ...
    $listeUserC = $userC->filterTable($nbr_place_d, $prix, $zone_d);
} else {
    $listeUserC = $userC->afficherCovoiturage();
}
...
<head>
    ...
    <title>Liste de Covoiturages Disponible</title>
    <meta charset="utf-8">
...
<body>
    ...
    <label for="nbr_place_d">Number of Seats:</label>
    <input type="text" id="nbr_place_d" name="nbr_place_d">
    <label for="prix">Price:</label>
    <input type="text" id="prix" name="prix">
    <label for="zone_d">Zone:</label>
    <input type="text" id="zone_d" name="zone_d">
                    ...
                    <tbody>
                        <?php foreach ($listeUserC as $covoiturge) { ?>
                            <tr>
                                ...
                                <td>
                                    <form method="post" action="annulebook.php">
                                        <input type="hidden" name="id_covoiturage" value="<?php echo $covoiturge['id_covoiturage']; ?>">
                                        <button type="submit" class="btn">Annule</button>
                                    </form>
                                </td>
