...
<div class="container p-5">
        ...
        ?>
            <tr>
                ...
                <td>
                            <a href="updateCategorie.php?Idcat=<?php echo $categorie['Idcat']; ?>" class="btn">modifier</a>
                            </td>
            
                <td>
                    <a href="deleteCategorie.php?Idcat=<?php echo $categorie['Idcat']; ?>">Delete</a>
                </td>
                <td>
    ...
    <a class="btn btn-primary" href="addCategorie.php">Add Categorie </a>
    <a class="btn btn-primary" href="SearchCategorie.php">Search Categorie </a>
    <a class="btn btn-primary" href="SortCategorie.php">Sort Categorie </a>
</div>
</section>
  </main><!-- End #main -->
