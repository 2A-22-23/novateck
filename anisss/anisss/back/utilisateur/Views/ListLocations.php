...
<div class="container p-5">
        ...
        ?>
            <tr>
                <td><?= $location['num_loc']; ?></td>
                <td><?= $location['d_dep']; ?></td>
                <td><?= $location['d_arr']; ?></td>
                <td><?= $location['etat_loc']; ?></td>
                
                <td align="center">
                    <form method="POST" action="updateLocation.php">
                        <input type="submit" name="update" value="Update">
                        <input type="hidden" value=<?PHP echo $location['num_loc']; ?> name="num_loc">
                    </form>
                </td>
                <td>
                    <a href="deleteLocation.php?num_loc=<?php echo $location['num_loc']; ?>">Delete</a>
                </td>
            </tr>
        <?php
        }
    ...
    <a class="btn btn-primary" href="addLocation.php">Add Location </a>
    <a class="btn btn-primary" href="SortLocation.php">Sort Location </a>
